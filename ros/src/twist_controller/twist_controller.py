...
class Controller(object):
    ...
    def control(self, current_vel, dbw_enabled, linear_vel, angualar_vel):
        # dTODO: Change the arg, kwarg list to suit your needs
        ...
        steering = self.yaw_controller.get_steering(linear_vel, angualar_vel, current_vel)
